...
BENCHMARK_TEMPLATE(deserialize_ints_cereal, cereal::BinaryInputArchive, cereal::BinaryOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_ints_cereal, cereal::BinaryInputArchive, cereal::BinaryOutputArchive, 10000);
BENCHMARK_TEMPLATE(deserialize_ints_cereal, cereal::PortableBinaryInputArchive, cereal::PortableBinaryOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_ints_cereal, cereal::PortableBinaryInputArchive, cereal::PortableBinaryOutputArchive, 10000);
BENCHMARK_TEMPLATE(deserialize_ints_cereal, cereal::JSONInputArchive, cereal::JSONOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_ints_cereal, cereal::JSONInputArchive, cereal::JSONOutputArchive, 10000);
...
BENCHMARK_TEMPLATE(deserialize_large_ints_cereal, cereal::BinaryInputArchive, cereal::BinaryOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_large_ints_cereal, cereal::BinaryInputArchive, cereal::BinaryOutputArchive, 10000);
BENCHMARK_TEMPLATE(deserialize_large_ints_cereal, cereal::PortableBinaryInputArchive, cereal::PortableBinaryOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_large_ints_cereal, cereal::PortableBinaryInputArchive, cereal::PortableBinaryOutputArchive, 10000);
BENCHMARK_TEMPLATE(deserialize_large_ints_cereal, cereal::JSONInputArchive, cereal::JSONOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_large_ints_cereal, cereal::JSONInputArchive, cereal::JSONOutputArchive, 10000);
...
BENCHMARK_TEMPLATE(deserialize_mixed_cereal, cereal::BinaryInputArchive, cereal::BinaryOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_mixed_cereal, cereal::BinaryInputArchive, cereal::BinaryOutputArchive, 10000);
BENCHMARK_TEMPLATE(deserialize_mixed_cereal, cereal::PortableBinaryInputArchive, cereal::PortableBinaryOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_mixed_cereal, cereal::PortableBinaryInputArchive, cereal::PortableBinaryOutputArchive, 10000);
BENCHMARK_TEMPLATE(deserialize_mixed_cereal, cereal::JSONInputArchive, cereal::JSONOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_mixed_cereal, cereal::JSONInputArchive, cereal::JSONOutputArchive, 10000);
...
BENCHMARK_TEMPLATE(deserialize_complex_cereal, cereal::BinaryInputArchive, cereal::BinaryOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_complex_cereal, cereal::BinaryInputArchive, cereal::BinaryOutputArchive, 10000);
BENCHMARK_TEMPLATE(deserialize_complex_cereal, cereal::PortableBinaryInputArchive, cereal::PortableBinaryOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_complex_cereal, cereal::PortableBinaryInputArchive, cereal::PortableBinaryOutputArchive, 10000);
BENCHMARK_TEMPLATE(deserialize_complex_cereal, cereal::JSONInputArchive, cereal::JSONOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_complex_cereal, cereal::JSONInputArchive, cereal::JSONOutputArchive, 10000);
...
BENCHMARK_TEMPLATE(deserialize_contvec_cereal, cereal::BinaryInputArchive, cereal::BinaryOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_contvec_cereal, cereal::BinaryInputArchive, cereal::BinaryOutputArchive, 10000);
BENCHMARK_TEMPLATE(deserialize_contvec_cereal, cereal::PortableBinaryInputArchive, cereal::PortableBinaryOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_contvec_cereal, cereal::PortableBinaryInputArchive, cereal::PortableBinaryOutputArchive, 10000);
BENCHMARK_TEMPLATE(deserialize_contvec_cereal, cereal::JSONInputArchive, cereal::JSONOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_contvec_cereal, cereal::JSONInputArchive, cereal::JSONOutputArchive, 10000);
...
BENCHMARK_TEMPLATE(deserialize_contmap_cereal, cereal::BinaryInputArchive, cereal::BinaryOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_contmap_cereal, cereal::BinaryInputArchive, cereal::BinaryOutputArchive, 10000);
BENCHMARK_TEMPLATE(deserialize_contmap_cereal, cereal::PortableBinaryInputArchive, cereal::PortableBinaryOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_contmap_cereal, cereal::PortableBinaryInputArchive, cereal::PortableBinaryOutputArchive, 10000);
BENCHMARK_TEMPLATE(deserialize_contmap_cereal, cereal::JSONInputArchive, cereal::JSONOutputArchive, 1000);
BENCHMARK_TEMPLATE(deserialize_contmap_cereal, cereal::JSONInputArchive, cereal::JSONOutputArchive, 10000);
