...
class Note
{
  ...
  public:
    ...
    Note(const bigint_t id, const std::string &title,
         const std::string &content, const bigint_t notebook_id,
         const pt::ptime &last_change, const pt::ptime &reminder)
    ...
    Note(const std::string &title, const std::string &content,
         const bigint_t notebook_id, const pt::ptime &reminder)
    ...
    inline void id(const bigint_t id) { id_ = id; }
    ...
    inline bigint_t notebook() const { return notebook_id_; }
    inline void notebook(const bigint_t notebook_id)
    {
